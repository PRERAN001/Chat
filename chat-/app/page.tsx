...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-black font-sans text-zinc-50 overflow-hidden selection:bg-zinc-800 selection:text-white">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900/40 via-black to-black opacity-80" />
      ...
      <main className="relative z-10 flex w-full max-w-4xl flex-col items-center justify-center gap-10 px-6 py-20 text-center">
        ...
        <div className="flex items-center gap-3 animate-fade-in-down">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-zinc-800 to-black shadow-lg border border-zinc-700/50">
            <svg 
              viewBox="0 0 24 24" 
              width="24" 
              height="24" 
        ...
        <div className="flex flex-col items-center gap-6">
          <h2 className="text-5xl font-extrabold tracking-tighter sm:text-6xl/tight md:text-7xl/tight bg-clip-text text-transparent bg-gradient-to-b from-white via-zinc-200 to-zinc-600 pb-2">
            Connect instantly. <br /> Communicate freely.
          </h2>
          <p className="max-w-[600px] text-lg text-zinc-400 sm:text-xl leading-relaxed">
        ...
        <div className="mt-4 flex flex-col items-center gap-4 w-full sm:w-auto">
          <div className="p-[1px] rounded-full bg-gradient-to-r from-zinc-700 via-zinc-400 to-zinc-700 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-shadow duration-500">
